 ...
 * logged out.
 */
Ext.define('ETM.util.SessionMonitor', {
    singleton: true,
    ...
    window: Ext.create('Ext.window.Window', {
        ...
        buttons: [{
            ...
            handler: function () {
                Ext.TaskManager.stop(ETM.util.SessionMonitor.countDownTask);
                ETM.util.SessionMonitor.window.hide();
